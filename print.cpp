...
void printStringS1(const char *s1)
{
  while (*s1)
    serial1_write(*s1++);
}
...
void printS1_uint8_base2(uint8_t n1)
{ 
...
void printS1_uint32_base10(unsigned long n1)
{ 
...
void printIntegerS1(long n1)
{
  if (n1 < 0) {
    serial1_write('-');
    n1 = -n1;
  }
  printS1_uint32_base10(n1);
}

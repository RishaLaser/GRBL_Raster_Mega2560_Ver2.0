...
//#define Z_ENABLE_DDR	DDRH
//#define Z_ENABLE_PORT	PORTH
//#define Z_ENABLE_BIT	3	//MEGA DIGITAL PIN 6
...
#define SPINDLE_ENABLE_BIT   5  // mega Digital Pin 8
...
#define PIN_RESET        0  // mega Analog Pin 0
#define PIN_FEED_HOLD    1  // mega Analog Pin 1
#define PIN_CYCLE_START  2  // mega Analog Pin 2
#define PINOUT_INT       PCIF1  // Pin change interrupt enable pin
